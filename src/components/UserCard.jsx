...
const UserCard = () => {
    return (
        <div className="flex justify-center items-center  bg-gray-900">
            <div className="max-w-sm w-full bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden dark:bg-gray-800 dark:border-gray-700">
                {/* Card Header */}
                ...
                <div className="text-center p-4">
                    <h5 className="text-xl font-bold text-gray-900 dark:text-white">Bonnie Green</h5>
